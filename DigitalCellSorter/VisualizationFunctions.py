...
class VisualizationFunctions:
    ...
    def makeMarkerExpressionPlot(self, fontscale = 0.75, dpi = 300, extension = 'png'):
        ...
        if True:
            ...
            ax.set_yticklabels(['Mean'] + [str(clusterNames[i]) + ' (' + str(clusterIndices[i]) + ')' for i in ORDER], rotation=0, fontsize=8*fontscale)
