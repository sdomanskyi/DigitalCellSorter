...
if __name__ == '__main__':
    ...
    if False:
        ...
        DCS.makeSankeyDiagram(df_new_marker_list, 'DCS_vs_DropClust detailed 2', colormapForIndex, colormapForColumns, title='DCS vs DropClust', quality=6)
    ...
    #    df_expr.columns.names = ['patient', 'cell']
    ...
    #    df_expr.columns = pd.MultiIndex.from_arrays([df_expr.columns.get_level_values('patient'), cells], names=['patient', 'cell'])
