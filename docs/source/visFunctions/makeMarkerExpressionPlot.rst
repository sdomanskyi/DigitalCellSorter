...
.. autoclass:: DigitalCellSorter.VisualizationFunctions.VisualizationFunctions
    ...
    .. automethod:: makeMarkerExpressionPlot


**Example output:**

.. thumbnail:: https://github.com/sdomanskyi/DigitalCellSorter/blob/master/docs/examples/output/BM1/BM1_marker_expression.png?raw=true
    :title: Example
