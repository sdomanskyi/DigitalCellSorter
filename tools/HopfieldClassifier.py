...
class HopfieldClassifier:
    ...
    def predict_proba(self,
        ...
        for sample in iterable:
            ovs = Run(self.attrs,self.tmax,self.T,sigma0,fractionToUpdate=self.fractionToUpdate,h_ext=h_ext)
...
def Update(attrs,sigma,T,Q_inv=None,fractionToUpdate=1.0,h_ext=None):
